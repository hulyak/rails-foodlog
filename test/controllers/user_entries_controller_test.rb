...
class UserEntriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_entry" do
    assert_difference('UserEntry.count') do
      post user_entries_url, params: { user_entry: { calories: @user_entry.calories, carbohydrates: @user_entry.carbohydrates, fats: @user_entry.fats, meal_type: @user_entry.meal_type, proteins: @user_entry.proteins } }
    end
  ...
  test "should update user_entry" do
    patch user_entry_url(@user_entry), params: { user_entry: { calories: @user_entry.calories, carbohydrates: @user_entry.carbohydrates, fats: @user_entry.fats, meal_type: @user_entry.meal_type, proteins: @user_entry.proteins } }
